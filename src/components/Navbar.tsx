            ...
            {user ? (
              <div className="flex items-center gap-4">
                ...
                <div className="relative group">
                  <button className="flex items-center justify-center w-9 h-9 rounded-full border-2 border-slate-200 hover:bg-slate-50 transition-colors bg-slate-100 text-slate-600">
                    <User size={18} />
                  </button>
